...
ALPHA = 0.00001#0.1  # learning rate for training
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        if for_training:
            # update Q-function.
            #Your code here
            tabular_q_learning(q_func, current_state_1, current_state_2, action_index, object_index, reward, next_state_1, next_state_2)
